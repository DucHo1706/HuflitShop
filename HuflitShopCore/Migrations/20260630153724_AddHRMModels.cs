...
{
    /// <inheritdoc />
    public partial class AddHRMModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShiftRegistrations_Users_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInIpAddress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CheckOutTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CheckOutIpAddress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CalculatedHours = table.Column<double>(type: "float", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftRegistrations_StaffId",
                table: "ShiftRegistrations",
                column: "StaffId");
