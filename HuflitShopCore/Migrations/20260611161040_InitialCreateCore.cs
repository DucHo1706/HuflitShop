        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarPublicId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    AvatarVersion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Trademark = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockReceived_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFullName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    ShippingDistrict = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetVersion = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPriceHistories_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ProductId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SizeId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ColorId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductViewsLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductViewsLog_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductViewsLog_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeNameSnapshot = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ColorNameSnapshot = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "StockReceivedDetails",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StockReceivedId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ProductVariantId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockReceivedDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockReceivedDetails_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockReceivedDetails_StockReceived_StockReceivedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductViewsLog_ProductId",
                table: "ProductViewsLog",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductViewsLog_UserId",
                table: "ProductViewsLog",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockReceived_SupplierId",
                table: "StockReceived",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_StockReceivedDetails_ProductVariantId",
                table: "StockReceivedDetails",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_StockReceivedDetails_StockReceivedId",
                table: "StockReceivedDetails",
